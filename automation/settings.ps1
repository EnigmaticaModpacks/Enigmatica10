...
# This is the modpack name as seen in it's CurseForge url: https://www.curseforge.com/minecraft/modpacks/[Enigmatica10]
$MODPACK_NAME = "Enigmatica10"
  ...
  <div style="position:relative;width:480px;height:480px;overflow:hidden;border-radius:8px;">
    ...
    <div style="position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;padding:24px;box-sizing:border-box;">
      ...
      <img src="https://github.com/EnigmaticaModpacks/Enigmatica10/blob/master/packmenu/resources/assets/enigmatica/textures/logo.png?raw=true"
           alt="Enigmatica 10" style="width:85%;margin-bottom:28px;filter:drop-shadow(0 2px 6px rgba(0,0,0,0.8));" />
...
$CLIENT_FILE_DISPLAY_NAME = "Enigmatica 10 $MODPACK_VERSION"
...
$SERVER_FILE_DISPLAY_NAME = "Enigmatica 10 Server $MODPACK_VERSION"
